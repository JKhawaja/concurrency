...
Every real (spatial and temporal) node can be represented by 4 numbers: spatial dependencies, temporal dependencies, spatial dependents, and temporal dependents.
...
Examples of various kinds of nodes would be:

\begin{itemize}
	\item Spatial Nodes: \{x, y, z, 0\}
	\item Spatial Boundary Nodes: \{x, y, 0, 0\}
	\item Temporal Nodes: \{0, x, y, z\}
	\item Temporal Boundary Nodes: \{0, 0, x, y\}
\end{itemize}
