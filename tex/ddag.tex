...
Boundary Nodes on our UI dependency graph can be useful for determining what access types are allowed for a UI.
...
ARE WE ALLOWING DYNAMIC (VIRTUAL) NODES TO HAVE REAL DEPENDENCIES??
...
\begin{itemize}
	\item Spatial Root Boundary Nodes: \{x, y, 0, 0\}
	\item Temporal Root Boundary Nodes: \{0, 0, x, y\}
\end{itemize}
